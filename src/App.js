...
function App() {
  return (
    <div className="App">
     ...
     <div className='w-75 mx-auto my-5'> <h3>How react work?</h3>
      ...
      <br />
      <h3 className=''>Difference between State and Props?</h3>
      <p><strong>Answer:</strong>1.	Props are read-only or State changes can be asynchronous.
